...
public class TriggerScriptslvCorridor02 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        to1FinalPosition = new Vector3(37.92007f, 0.395699f, -19.31f);
        to1startingPosition = new Vector3(37.92007f, 0.395699f, -8.450827f);
